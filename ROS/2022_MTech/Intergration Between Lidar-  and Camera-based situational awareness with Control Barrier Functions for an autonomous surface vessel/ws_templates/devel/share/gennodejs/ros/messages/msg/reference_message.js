...
class reference_message {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('eta_ds2')) {
        this.eta_ds2 = initObj.eta_ds2
      }
      else {
        this.eta_ds2 = [];
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [eta_ds2]
    bufferOffset = _arraySerializer.float64(obj.eta_ds2, buffer, bufferOffset, null);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [eta_ds2]
    data.eta_ds2 = _arrayDeserializer.float64(buffer, bufferOffset, null)
  ...
  static getMessageSize(object) {
    ...
    length += 8 * object.eta_ds2.length;
    return length + 36;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.eta_ds2 !== undefined) {
      resolved.eta_ds2 = msg.eta_ds2;
    }
    else {
      resolved.eta_ds2 = []
    }
