...
if("TRUE" STREQUAL "TRUE")
  set(simulator_SOURCE_PREFIX /home/dplab/ws_templates/src/simulator)
  set(simulator_DEVEL_PREFIX /home/dplab/ws_templates/devel)
  ...
  set(simulator_INSTALL_PREFIX /home/dplab/ws_templates/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'simulator' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dplab/ws_templates/src/simulator/${idir}'.  ${_report}")
    endif()
