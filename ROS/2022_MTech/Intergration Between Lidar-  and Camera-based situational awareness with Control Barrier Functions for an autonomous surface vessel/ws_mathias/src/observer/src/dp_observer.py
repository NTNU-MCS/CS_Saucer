#!/usr/bin/env python3
# ----------------------------------------------------------------------------
# This code is part of the Mathias Solheim's master thesis, and contains a ROS
# implementation of a DP observer. The observer takes positional estimates and 
# returns a estimates of postion, velocity and bias. 
#
# The observer follows the design of Svenn Are Værnø and Roger Skjetne (2017)
#
