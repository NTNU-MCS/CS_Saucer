...
class reference_message(genpy.Message):
  _md5sum = "32123cd43ccb33fbbded09fe4a9ec786"
...
float64 v_ss
"""
  __slots__ = ['eta_d','eta_d_prime','eta_d_prime2','eta_ds','w','v_s','v_ss']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       eta_d,eta_d_prime,eta_d_prime2,eta_ds,w,v_s,v_ss
    ...
    if args or kwds:
      ...
      if self.eta_d is None:
        self.eta_d = []
      if self.eta_d_prime is None:
        self.eta_d_prime = []
      if self.eta_d_prime2 is None:
        self.eta_d_prime2 = []
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.eta_d_prime)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.eta_d_prime))
      length = len(self.eta_d_prime2)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.eta_d_prime2))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.eta_d_prime = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.eta_d_prime2 = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.eta_d_prime.tostring())
      length = len(self.eta_d_prime2)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.eta_d_prime2.tostring())
      length = len(self.eta_ds)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.eta_d_prime = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.eta_d_prime2 = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
