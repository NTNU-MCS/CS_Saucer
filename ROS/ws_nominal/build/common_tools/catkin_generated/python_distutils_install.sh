...
echo_and_run cd "/home/dplab/ws_nominal/src/common_tools"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/dplab/ws_nominal/src/common_tools/setup.py" \
     \
    build --build-base "/home/dplab/ws_nominal/build/common_tools" \
    install \
    --root="${DESTDIR-/}" \
