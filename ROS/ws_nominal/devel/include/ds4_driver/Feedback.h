...
bool operator==(const ::ds4_driver::Feedback_<ContainerAllocator1> & lhs, const ::ds4_driver::Feedback_<ContainerAllocator2> & rhs)
{
  return lhs.set_led == rhs.set_led &&
    lhs.led_r == rhs.led_r &&
    lhs.led_g == rhs.led_g &&
    lhs.led_b == rhs.led_b &&
    lhs.set_led_flash == rhs.set_led_flash &&
    lhs.led_flash_on == rhs.led_flash_on &&
    lhs.led_flash_off == rhs.led_flash_off &&
    lhs.set_rumble == rhs.set_rumble &&
    lhs.rumble_duration == rhs.rumble_duration &&
    lhs.rumble_small == rhs.rumble_small &&
    lhs.rumble_big == rhs.rumble_big;
}
