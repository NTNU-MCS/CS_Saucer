...
class Object {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('box')) {
        ...
        this.box = new sensor_msgs.msg.RegionOfInterest();
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = sensor_msgs.msg.RegionOfInterest.serialize(obj.box, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.box = sensor_msgs.msg.RegionOfInterest.deserialize(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    if (msg.box !== undefined) {
      resolved.box = sensor_msgs.msg.RegionOfInterest.Resolve(msg.box)
    }
    else {
      resolved.box = new sensor_msgs.msg.RegionOfInterest()
    }
