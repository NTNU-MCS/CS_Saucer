...
persistent Desired_Docking_Heading Count hh1 hh2 h1 h2 h3 h4 h5 h6 h7 h8 h9 Optimal_path Optimal_pathOld UnFlagList GAPS RobotPositionYMapLog RobotPositionXLog writerObj ;
...
if (ishandle(h1)==1)
    ...
    hold on
    plot(-10,-10,'square','color','k','MarkerSize',10,'MarkerEdgeColor','k','MarkerFaceColor','k')                              %Occupied
    plot(-10,-10,'square','color',[0.5 0.5 0.5],'MarkerSize',10,'MarkerEdgeColor',[0.5 0.5 0.5],'MarkerFaceColor',[0.5 0.5 0.5])%Free
    plot(-20,-20,'square','color',[0 0 0],'MarkerSize',10,'MarkerEdgeColor',[0 0 0],'MarkerFaceColor',[1 1 1])                  %Unexplored
    ...
    h1=plot(nan,nan,'o','color','r','MarkerFaceColor','r','MarkerSize',7,'LineWidth',2);%Vessel Position
