...
typedef struct {
  ...
  real_T x_c[52];
  real_T dv3[9];
  SL_Bus_ROS_Controller_geometry_msgs_Vector3 In1;// '<S26>/In1'
  SL_Bus_ROS_Controller_geometry_msgs_Vector3 In1_i;// '<S24>/In1'
  SL_Bus_ROS_Controller_geometry_msgs_Vector3 BusAssignment3;// '<S14>/Bus Assignment3' 
  ...
  real_T r_p;
  SL_Bus_ROS_Controller_std_msgs_Float64 BusAssignment1;// '<S3>/Bus Assignment1' 
  SL_Bus_ROS_Controller_std_msgs_Bool In1_h;// '<S34>/In1'
  int32_T low_i;
  int32_T low_ip1;
} B_ROS_Controller_T;
...
typedef struct {
  ...
  robotics_slros_internal_blo_b_T obj_pd;// '<S33>/SourceBlock'
  robotics_slros_internal_blo_b_T obj_k;// '<S25>/SourceBlock'
  robotics_slros_internal_blo_b_T obj_o;// '<S23>/SourceBlock'
...
struct P_ROS_Controller_T_ {
  ...
  SL_Bus_ROS_Controller_geometry_msgs_Vector3 Constant_Value_f;// Computed Parameter: Constant_Value_f
  ...
  SL_Bus_ROS_Controller_std_msgs_Float64 Constant_Value_hl;// Computed Parameter: Constant_Value_hl
                                                           //  Referenced by: '<S12>/Constant'

  SL_Bus_ROS_Controller_std_msgs_UInt16 Constant_Value_b;// Computed Parameter: Constant_Value_b
                                                         //  Referenced by: '<S28>/Constant'

  SL_Bus_ROS_Controller_std_msgs_UInt16 Constant_Value_c;// Computed Parameter: Constant_Value_c
                                                         //  Referenced by: '<S35>/Constant'

  SL_Bus_ROS_Controller_std_msgs_Bool Out1_Y0_p;// Computed Parameter: Out1_Y0_p
                                                //  Referenced by: '<S34>/Out1'

  SL_Bus_ROS_Controller_std_msgs_Bool Constant_Value_j;// Computed Parameter: Constant_Value_j
...
//  '<S2>'   : 'ROS_Controller/EINAR2180MAP1'
//  '<S3>'   : 'ROS_Controller/NonlinearPassiveObs'
//  '<S4>'   : 'ROS_Controller/Subsystem'
//  '<S5>'   : 'ROS_Controller/Subsystem1'
//  '<S6>'   : 'ROS_Controller/ThirdOrderFossen 1'
//  '<S7>'   : 'ROS_Controller/ThrustDynamics'
//  '<S8>'   : 'ROS_Controller/UOUT'
//  '<S9>'   : 'ROS_Controller/aout'
//  '<S10>'  : 'ROS_Controller/DPcontroller/Rotation Matrix'
//  '<S11>'  : 'ROS_Controller/EINAR2180MAP1/PWM-Mapping'
//  '<S12>'  : 'ROS_Controller/NonlinearPassiveObs/Blank Message1'
//  '<S13>'  : 'ROS_Controller/NonlinearPassiveObs/MATLAB Function'
//  '<S14>'  : 'ROS_Controller/NonlinearPassiveObs/NuOut'
//  '<S15>'  : 'ROS_Controller/NonlinearPassiveObs/Publish1'
//  '<S16>'  : 'ROS_Controller/NonlinearPassiveObs/Subsystem'
//  '<S17>'  : 'ROS_Controller/NonlinearPassiveObs/NuOut/Blank Message1'
//  '<S18>'  : 'ROS_Controller/NonlinearPassiveObs/NuOut/Publish3'
//  '<S19>'  : 'ROS_Controller/NonlinearPassiveObs/Subsystem/Correalis matrix'
//  '<S20>'  : 'ROS_Controller/NonlinearPassiveObs/Subsystem/Dampening matrix'
//  '<S21>'  : 'ROS_Controller/NonlinearPassiveObs/Subsystem/MATLAB Function'
//  '<S22>'  : 'ROS_Controller/NonlinearPassiveObs/Subsystem/MATLAB Function1'
//  '<S23>'  : 'ROS_Controller/Subsystem/Subscribe2'
//  '<S24>'  : 'ROS_Controller/Subsystem/Subscribe2/Enabled Subsystem'
//  '<S25>'  : 'ROS_Controller/Subsystem1/Subscribe2'
//  '<S26>'  : 'ROS_Controller/Subsystem1/Subscribe2/Enabled Subsystem'
//  '<S27>'  : 'ROS_Controller/ThrustDynamics/Torque Saturation'
//  '<S28>'  : 'ROS_Controller/UOUT/Blank Message1'
//  '<S29>'  : 'ROS_Controller/UOUT/Calibrate'
//  '<S30>'  : 'ROS_Controller/UOUT/Publish1'
//  '<S31>'  : 'ROS_Controller/UOUT/Publish2'
//  '<S32>'  : 'ROS_Controller/UOUT/Publish3'
//  '<S33>'  : 'ROS_Controller/UOUT/Subscribe2'
//  '<S34>'  : 'ROS_Controller/UOUT/Subscribe2/Enabled Subsystem'
//  '<S35>'  : 'ROS_Controller/aout/Blank Message1'
//  '<S36>'  : 'ROS_Controller/aout/PWM2Map180 '
//  '<S37>'  : 'ROS_Controller/aout/Publish1'
//  '<S38>'  : 'ROS_Controller/aout/Publish2'
//  '<S39>'  : 'ROS_Controller/aout/Publish3'
