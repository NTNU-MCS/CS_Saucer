...
{
  runModel = (rtmGetErrorStatus(LidarMapSim128_M) == (NULL));
  while (runModel) {
...
{
  rtmSetErrorStatus(LidarMapSim128_M, "stopping the model");
}
...
int main(int argc, char **argv)
{
  ...
  fflush(stdout);
  rtmSetErrorStatus(LidarMapSim128_M, 0);

  // Initialize model
  LidarMapSim128_initialize();
