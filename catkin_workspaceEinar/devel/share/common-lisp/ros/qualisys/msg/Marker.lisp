...
(cl:defmethod cl:initialize-instance :after ((m <Marker>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Marker)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name qualisys-msg:<Marker> is deprecated: use qualisys-msg:Marker instead.")))
...
(cl:defmethod subject_name-val ((m <Marker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader qualisys-msg:subject_name-val is deprecated.  Use qualisys-msg:subject_name instead.")
  (subject_name m))
