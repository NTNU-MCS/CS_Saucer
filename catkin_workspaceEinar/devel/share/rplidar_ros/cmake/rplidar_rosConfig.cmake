...
if("TRUE" STREQUAL "TRUE")
  set(rplidar_ros_SOURCE_PREFIX /home/einar/catkin_ws/src/rplidar_ros)
  set(rplidar_ros_DEVEL_PREFIX /home/einar/catkin_ws/devel)
  ...
  set(rplidar_ros_INSTALL_PREFIX /home/einar/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'rplidar_ros' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Ling <mickey.leen@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'rplidar_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/einar/catkin_ws/src/rplidar_ros/${idir}'.  Ask the maintainer 'Ling <mickey.leen@gmail.com>' to fix it.")
    endif()
