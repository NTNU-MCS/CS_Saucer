...
if("TRUE" STREQUAL "TRUE")
  set(multimaster_msgs_fkie_SOURCE_PREFIX /home/einar/catkin_ws/src/multimaster_fkie/multimaster_msgs_fkie)
  set(multimaster_msgs_fkie_DEVEL_PREFIX /home/einar/catkin_ws/devel)
  ...
  set(multimaster_msgs_fkie_INSTALL_PREFIX /home/einar/catkin_ws/install)
...
if(NOT "/home/einar/catkin_ws/devel/include " STREQUAL " ")
  set(multimaster_msgs_fkie_INCLUDE_DIRS "")
  set(_include_dirs "/home/einar/catkin_ws/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'multimaster_msgs_fkie' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Alexander Tiderko <alexander.tiderko@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'multimaster_msgs_fkie' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/einar/catkin_ws/src/multimaster_fkie/multimaster_msgs_fkie/${idir}'.  Ask the maintainer 'Alexander Tiderko <alexander.tiderko@gmail.com>' to fix it.")
    endif()
...
set(multimaster_msgs_fkie_EXPORTED_TARGETS "multimaster_msgs_fkie_generate_messages_cpp;multimaster_msgs_fkie_generate_messages_lisp;multimaster_msgs_fkie_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${multimaster_msgs_fkie_dep}_FOUND)
      find_package(${multimaster_msgs_fkie_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${multimaster_msgs_fkie_dep} REQUIRED ${depend_list})
  endif()
