...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2dB.pack(_x.master.timestamp, _x.master.timestamp_local, _x.master.online))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.master.timestamp, _x.master.timestamp_local, _x.master.online,) = _struct_2dB.unpack(str[start:end])
