...
// Conversions between SL_Bus_TESTT_geometry_msgs_Point and geometry_msgs::Point
...
// Conversions between SL_Bus_TESTT_geometry_msgs_Pose and geometry_msgs::Pose
...
// Conversions between SL_Bus_TESTT_geometry_msgs_PoseWithCovariance and geometry_msgs::PoseWithCovariance
...
// Conversions between SL_Bus_TESTT_geometry_msgs_PoseWithCovarianceStamped and geometry_msgs::PoseWithCovarianceStamped
...
// Conversions between SL_Bus_TESTT_geometry_msgs_Quaternion and geometry_msgs::Quaternion
...
// Conversions between SL_Bus_TESTT_nav_msgs_MapMetaData and nav_msgs::MapMetaData
...
// Conversions between SL_Bus_TESTT_nav_msgs_OccupancyGrid and nav_msgs::OccupancyGrid
...
{
  {
    ...
    {
      ROS_WARN_NAMED("TESTT", "Truncating array '%s' in received message '%s' from %d to %d items", "data", "nav_msgs/OccupancyGrid", numItemsToCopy, 16384);
...
// Conversions between SL_Bus_TESTT_ros_time_Time and ros::Time
...
// Conversions between SL_Bus_TESTT_std_msgs_Header and std_msgs::Header
...
{
  {
    ...
    {
      ROS_WARN_NAMED("TESTT", "Truncating array '%s' in received message '%s' from %d to %d items", "frame_id", "std_msgs/Header", numItemsToCopy, 128);
      numItemsToCopy = 128;
    }
