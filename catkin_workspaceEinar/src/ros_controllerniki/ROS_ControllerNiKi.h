...
//
#ifndef RTW_HEADER_ROS_ControllerNiKi_h_
#define RTW_HEADER_ROS_ControllerNiKi_h_
#include <math.h>
#include <string.h>
#include <stddef.h>
#ifndef ROS_ControllerNiKi_COMMON_INCLUDES_
# define ROS_ControllerNiKi_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "rtw_continuous.h"
#include "rtw_solver.h"
#include "slros_initialize.h"
#endif                                 // ROS_ControllerNiKi_COMMON_INCLUDES_
...
typedef struct {
  ...
  real_T dv0[9];
  SL_Bus_ROS_ControllerNiKi_geometry_msgs_Vector3 In1;// '<S17>/In1'
  SL_Bus_ROS_ControllerNiKi_geometry_msgs_Vector3 In1_i;// '<S15>/In1'
  SL_Bus_ROS_ControllerNiKi_geometry_msgs_Vector3 BusAssignment1;// '<S7>/Bus Assignment1' 
...
struct P_ROS_ControllerNiKi_T_ {
  ...
  SL_Bus_ROS_ControllerNiKi_geometry_msgs_Vector3 Out1_Y0;// Computed Parameter: Out1_Y0
                                                          //  Referenced by: '<S15>/Out1'

  SL_Bus_ROS_ControllerNiKi_geometry_msgs_Vector3 Constant_Value;// Computed Parameter: Constant_Value
                                                                 //  Referenced by: '<S14>/Constant'

  SL_Bus_ROS_ControllerNiKi_geometry_msgs_Vector3 Out1_Y0_d;// Computed Parameter: Out1_Y0_d
                                                            //  Referenced by: '<S17>/Out1'

  SL_Bus_ROS_ControllerNiKi_geometry_msgs_Vector3 Constant_Value_k;// Computed Parameter: Constant_Value_k
                                                                   //  Referenced by: '<S16>/Constant'

  SL_Bus_ROS_ControllerNiKi_geometry_msgs_Vector3 Constant_Value_d;// Computed Parameter: Constant_Value_d
...
struct tag_RTM_ROS_ControllerNiKi_T {
  ...
  struct {
    X_ROS_ControllerNiKi_T *contStates;
...
extern "C" {
  ...
  extern P_ROS_ControllerNiKi_T ROS_ControllerNiKi_P;
...
// Block signals (auto storage)
extern B_ROS_ControllerNiKi_T ROS_ControllerNiKi_B;

// Continuous states (auto storage)
extern X_ROS_ControllerNiKi_T ROS_ControllerNiKi_X;

// Block states (auto storage)
extern DW_ROS_ControllerNiKi_T ROS_ControllerNiKi_DW;
...
extern "C" {
  ...
  extern void ROS_ControllerNiKi_initialize(void);
  extern void ROS_ControllerNiKi_step(void);
  extern void ROS_ControllerNiKi_terminate(void);
...
extern "C" {
  ...
  extern RT_MODEL_ROS_ControllerNiKi_T *const ROS_ControllerNiKi_M;
...
//
//  '<Root>' : 'ROS_ControllerNiKi'
//  '<S1>'   : 'ROS_ControllerNiKi/DPcontroller'
//  '<S2>'   : 'ROS_ControllerNiKi/NonlinearPassiveObs'
//  '<S3>'   : 'ROS_ControllerNiKi/Subsystem'
//  '<S4>'   : 'ROS_ControllerNiKi/Subsystem1'
//  '<S5>'   : 'ROS_ControllerNiKi/ThirdOrderFossen 1'
//  '<S6>'   : 'ROS_ControllerNiKi/ThrustDynamics'
//  '<S7>'   : 'ROS_ControllerNiKi/U out'
//  '<S8>'   : 'ROS_ControllerNiKi/DPcontroller/Rotation Matrix'
//  '<S9>'   : 'ROS_ControllerNiKi/NonlinearPassiveObs/Subsystem'
//  '<S10>'  : 'ROS_ControllerNiKi/NonlinearPassiveObs/Subsystem/Correalis matrix'
//  '<S11>'  : 'ROS_ControllerNiKi/NonlinearPassiveObs/Subsystem/Dampening matrix'
//  '<S12>'  : 'ROS_ControllerNiKi/NonlinearPassiveObs/Subsystem/MATLAB Function'
//  '<S13>'  : 'ROS_ControllerNiKi/NonlinearPassiveObs/Subsystem/MATLAB Function1'
//  '<S14>'  : 'ROS_ControllerNiKi/Subsystem/Subscribe2'
//  '<S15>'  : 'ROS_ControllerNiKi/Subsystem/Subscribe2/Enabled Subsystem'
//  '<S16>'  : 'ROS_ControllerNiKi/Subsystem1/Subscribe2'
//  '<S17>'  : 'ROS_ControllerNiKi/Subsystem1/Subscribe2/Enabled Subsystem'
//  '<S18>'  : 'ROS_ControllerNiKi/ThrustDynamics/Torque Saturation'
//  '<S19>'  : 'ROS_ControllerNiKi/U out/Blank Message1'
//  '<S20>'  : 'ROS_ControllerNiKi/U out/Publish1'

#endif                                 // RTW_HEADER_ROS_ControllerNiKi_h_
