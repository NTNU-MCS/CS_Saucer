...
{
  {
    ...
    {
      ROS_WARN_NAMED("etasetget256Discretized2", "Truncating array '%s' in received message '%s' from %d to %d items", "data", "std_msgs/Float32MultiArray", numItemsToCopy, 256);
      numItemsToCopy = 256;
    }
...
{
  {
    ...
    if (numItemsToCopy > 256)
    {
      ROS_WARN_NAMED("etasetget256Discretized2", "Truncating array '%s' in received message '%s' from %d to %d items", "label", "std_msgs/MultiArrayDimension", numItemsToCopy, 256);
      numItemsToCopy = 256;
    }
